      ...
      <div className="max-w-[1280px] mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-20">
          <div className="space-y-6">
            <h2 className="text-[24px] font-black tracking-tighter uppercase text-black">
              Why we built this
            </h2>
            <p className="text-[16px] text-black/50 leading-[1.7]">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 border border-black/10">
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-black flex items-center
                                justify-center text-white font-mono text-[11px]
                                flex-shrink-0">
                  OC
                </div>
                <div>
                  <p className="text-[16px] font-black tracking-tighter uppercase text-black">
                    Oliver Cook KC
                  </p>
                  <p className="text-[13px] text-black/30 mt-0.5">
            ...
            <div className="bg-white p-6 border border-black/10">
              ...
              <p className="text-[13px] text-black/30 mt-4 font-medium">
        ...
        <div className="bg-black px-8 py-8
                        grid grid-cols-1 md:grid-cols-3 gap-px border border-white/10 mb-16">
          {[
            { n: '2,366', label: 'Regulatory documents in corpus' },
            { n: '65,822', label: 'Individual provisions searchable' },
            { n: '3', label: 'Jurisdictions live' },
          ].map((s, i) => (
            <div key={i} className="flex flex-col bg-black px-4">
              <span className="text-[42px] font-black text-white leading-none tracking-tighter">
                {s.n}
              </span>
              <span className="font-mono text-[11px] text-white/30 uppercase tracking-[0.2em] mt-2">{s.label}</span>
            </div>
          ))}
        </div>
        ...
        <div className="text-center">
          <h2 className="text-[32px] font-black tracking-tighter uppercase text-black mb-4">
            Ready to try it?
          </h2>
          <p className="text-[16px] text-black/50 mb-8">
